                ...
                return(
                    <SwiperSlide key={val.id}>
                        ...
                        <ul className="car-price">
                            <li className="price"><span>차량가격</span><span>{Number(val.carmodel[0].price).toLocaleString()}원</span></li>
                            <li className="month-price"><span>월 렌탈료</span><span>{Math.ceil(Number(val.carmodel[0].price) / 48).toLocaleString()}원</span></li>
                        </ul>
